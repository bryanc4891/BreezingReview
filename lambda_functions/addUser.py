...
def lambda_handler(event, context):
    ...
    if queryParams is None or queryParams.get('userid') is None or queryParams.get('username') is None or queryParams.get('useremail') is None:
        res["statusCode"] = 400
    ...
    defaultCity = "Tacoma"
    queryString = f"INSERT INTO User (UserID, UserName, UserEmail, DefaultCity) VALUES ('{userId}', '{userName}', '{userEmail}', '{defaultCity}')"
    print(queryString)
